...
async function jsd() {
    ...
    try {
        ...
        if (condition.innerHTML === "haze" && window.innerWidth > 600) {
            body.style.backgroundImage = " linear-gradient(rgba(94, 94, 94, 0.56)), url('haze_pc.jpg')";
            ...
            body.style.backgroundImage = " linear-gradient(rgba(132, 132, 132, 0.45)), url('haze.png')";
            body.style.backgroundSize = "cover";
            body.style.color = "white";
            condition.style.color = "white";
            owner.style.color = "white";
            ...
            body.style.backgroundImage = " linear-gradient(rgba(73, 73, 73, 0.51)), url('clear_sky.png')";
            body.style.backgroundSize = "cover";
            body.style.color = "white";
            condition.style.color = "white";
            owner.style.color = "white";
